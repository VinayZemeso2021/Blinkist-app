...
const EntrepreneurComp = ({books, setBooks, data, setData, library, setLibrary, ...props}:any)=>{
    ...
    return (
        <Container sx={{marginBottom:'100px', marginLeft:"125px"}}>
           
            <Banner1/>
            <Input className={classes.input} startIcon={<Search />} placeholder="Search by title or author" sx={{display:'flex',jusstifyContent:'start', color:'#6D787E'}} />
            <Box>
                {
                data.map((curr:any)=>{
