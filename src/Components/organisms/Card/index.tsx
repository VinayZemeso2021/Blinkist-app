...
const CardComponent = ({imgHeight, url, bookName, writerName, timeRead = "0-minute read", progress, width, inLibrary, libraryHandler,cardId}: any) => {
    ...
    return(
        <Paper data-testid='card-body' elevation={1} sx={{
            ...
            <Box sx={{backgroundColor: `${!inLibrary && hoverState ? theme.palette.primary.light : 'white'}`}} style={styles.content}  data-testid='card-box'>
                ...
                <Box style={styles.flex}  sx={{display:'flex',justifyContent:'start'}}>
                    ...
                    <Typography variant1="caption2" color={theme.palette.textcolor.light}>{timeRead}
                    </Typography>
                </Box>
                ...
                <Button sx={{color:'#0365F2', marginLeft:"100px"}}>Finished</Button>
            </Box>
